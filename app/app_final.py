...
def get_crop_image(crop_name):
    """Get the appropriate image for a crop"""
    try:
        # Simple and accurate crop image mapping
        crop_images = {
            # Grains - use rice image for all grain crops
            'rice': 'rice.jpg',
            'wheat': 'rice.jpg',  # Both are grains
            'barley': 'rice.jpg',
            'oats': 'rice.jpg',
            'millet': 'rice.jpg',
            'sorghum': 'rice.jpg',
            
            # Corn/Maize - use maize image
            'maize': 'maize.jpeg',
            'corn': 'maize.jpeg',
            ...
            # Vegetables and others - use generic image
            'tomato': 'etc.jpg',
            'potato': 'etc.jpg',
            'onion': 'etc.jpg',
            'garlic': 'etc.jpg',
        ...
        # Get image filename
        image_filename = crop_images.get(crop_name.lower(), 'etc.jpg')
        ...
        print(f"Error loading image for {crop_name}: {e}")
        return None, None

def get_fertilizer_image(fertilizer_name):
    """Get the appropriate image for a fertilizer"""
    try:
        fertilizer_images = {
            'urea': 'Urea.png',
            'dap': 'DAP.png',
        ...
        image_filename = fertilizer_images.get(fertilizer_name.lower(), 'Urea.png')
...
def crop_name():
    try:
        ...
        image_data, image_url = get_crop_image(myprediction)
...
def fertilizer_name():
    try:
        ...
        image_data, image_url = get_fertilizer_image(recommended_fertilizer)
